...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PRODUCTRESPONSE']._serialized_end=135
  _globals['_PRODUCTSERVICE']._serialized_start=137
  _globals['_PRODUCTSERVICE']._serialized_end=218
